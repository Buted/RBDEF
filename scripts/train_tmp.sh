...
# CUDA_VISIBLE_DEVICES=1 python main.py --exp_name $exp_name --mode "evaluate" --sub_mode "best-meta-3wKshot"
...
# python main.py --exp_name $exp_name --mode "save" --sub_mode "best-weighted"
