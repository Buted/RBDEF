...
# CUDA_VISIBLE_DEVICES=1 python main.py --exp_name $exp_name --mode "indicator" --sub_mode "best-seed519"
# python main.py --exp_name $exp_name --mode "rank" --sub_mode "best-seed519-False"
