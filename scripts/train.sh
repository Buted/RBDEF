...
# python main.py --exp_name $exp_name --mode "indicator" --sub_mode "best-seed99-scale"
# python main.py --exp_name $exp_name --mode "rank" --sub_mode "test-base99-scale"
# CUDA_VISIBLE_DEVICES=0 python main.py --exp_name $exp_name --mode "important"  
# python main.py --exp_name $exp_name --mode "save" --sub_mode "42"
